...
export default function Contact() {
  ...
  return (
    <section id="contact" className="relative py-20 lg:py-32 bg-white">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            >
              ...
              <p className="text-gray-600 text-sm leading-relaxed mb-6">
                ...
                in AI/ML engineering and full-stack development. Let's discuss how I can help.
              </p>
            </motion.div>
              ...
              {contactInfo.map((info, index) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm font-semibold text-gray-900 group-hover:text-royal-800 transition-colors">
                      {info.value}
                    </p>
                  </div>
                </motion.a>
                ...
                <div className="grid sm:grid-cols-2 gap-5">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full px-4 py-3 bg-white border border-gray-200 rounded-xl focus:ring-2 focus:ring-royal-500 focus:border-royal-500 outline-none transition-all text-sm"
