        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-400 text-sm leading-relaxed max-w-md mb-6">
              Building intelligent web applications that merge machine learning with modern 
              full-stack development. Available for freelance projects, internships, and 
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <a href="mailto:tushardogne123@gmail.com" className="text-gray-400 hover:text-white transition-colors">
                  tushardogne123@gmail.com
                </a>
              </li>
              <li>
                <a href="tel:+919302858988" className="text-gray-400 hover:text-white transition-colors">
                  +91 93028 58988
                </a>
              </li>
